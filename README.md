...
The goal of this assignment is to explore different machine learning models to create an algorithmic trading model. The signal uses the combination of the 4 and 100 sma. So, when price, and the fast sma is above the slow sma, it creates a buy signal. We will use this trading signal with two different supervised learning models from sklearn in python, SVC and Linear Regression. 

### SVC

![Decorative image.](Images/svc_returns_analysis.png)

### Linear Regression

![Decorative image.](Images/regression_returns_analysis.png)

### Conclusion

Comparing both result graphs, SVC has performed better than the linear regression model. However, the linear regrssion model performed very well into late 2021. This suggests that this model is not as adaptive as the SVC model. 
